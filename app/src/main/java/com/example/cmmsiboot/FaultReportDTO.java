...
/**
    ...
    public FrDto withClientFrId(Object clientFrId) {
        this.clientFrId = clientFrId;
        return this;
    }
    ...
    public FrDto withRequestorName(String requestorName) {
        this.requestorName = requestorName;
        return this;
    }
    ...
    public FrDto withRequesterName(String requesterName) {
        this.requesterName = requesterName;
        return this;
    }
...
/**
    ...
    public Building(Integer id, String name, String description) {
        super();
        this.id = id;
        this.name = name;
...
/**
    ...
    public Division(Integer id, String name, String description, Workspace_ workspace) {
        super();
        this.id = id;
        this.name = name;
        this.description = description;
...
/**
    ...
    public FaultCategory(Integer id, String name, String description, Priorty priorty, Workspace__2 workspace) {
        super();
        this.id = id;
        this.name = name;
        this.description = description;
    ...
    public FaultCategory withId(Integer id) {
        this.id = id;
        return this;
    }
...
/**
    ...
    public Priority(Integer id, String priorityId, Workspace__3 workspace, String priorityDesc) {
        super();
        this.id = id;
    ...
    public Priority withId(Integer id) {
        this.id = id;
        return this;
    }
...
/**
    ...
    public Priorty(Integer id, String priorityId, Workspace__1 workspace, String priorityDesc) {
        super();
        this.id = id;
        this.priorityId = priorityId;
        this.workspace = workspace;
...
/**
    ...
    public Department(Integer id, String name, String description, Workspace__4 workspace) {
        super();
        this.id = id;
        this.name = name;
        this.description = description;
...
/**
    ...
    public MaintGrp(Integer id, String name, String description, Object status, Workspace__5 workspace) {
        super();
        this.id = id;
        this.name = name;
        this.description = description;
...
/**
    ...
    public AttendedBy(Integer id, String name, Object designation, Object department, Object status, Object deviceToken, Object email) {
        super();
        this.id = id;
        this.name = name;
    ...
    public AttendedBy withId(Integer id) {
        this.id = id;
        return this;
    }
...
/**
    ...
    public Location(Integer id, String name, String description, String streetName, Object lat, Object lng) {
        super();
        this.id = id;
        this.name = name;
        this.description = description;
